...
function EventGlassOverlay({ event, compact = false }: { event: SellerEvent; compact?: boolean }) {
  ...
  return <BlurView blurType="regular" blurAmount={20} blurRounds={5} style={compact ? s.upcomingGlass : s.featuredGlass}>
...
const s = StyleSheet.create({
  ...
  featuredGlass: { position: 'absolute', left: 10, right: 10, bottom: 10, minHeight: 108, borderRadius: 22, overflow: 'hidden', padding: 14, borderWidth: 1, borderColor: '#FFFFFF88' },
