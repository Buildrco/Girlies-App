...
import type { ProfileRecord } from '../lib/social';
...
export default function Profile() {
  ...
  const load = useCallback(async (userId: string | null) => {
    ...
    const [profileResult, postsResult] = await Promise.all([
      supabase.from('profiles').select('id,display_name,handle,bio,avatar_url,verified,followers_count,following_count,created_at').eq('id', userId).maybeSingle(),
