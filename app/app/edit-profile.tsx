...
export default function EditProfile() {
  ...
  return <SafeAreaView style={s.safe}><KeyboardAvoidingView style={s.flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
    ...
    <ScrollView contentContainerStyle={s.scroll} keyboardShouldPersistTaps="handled">
      ...
      <View style={s.row}><View style={s.half}><Selector label="Country" value={country} placeholder="Select country" onPress={() => { setQuery(''); setPicker('country'); }} /></View><View style={s.half}><Selector label="Area" value={area} placeholder={country ? 'Select area' : 'Choose country first'} disabled={!country || areasLoading} onPress={() => { setQuery(''); setPicker('area'); }} /></View></View>
      <Selector label="Town / city" value={town} placeholder={area ? 'Select town or city' : 'Choose area first'} disabled={!area} onPress={() => { setQuery(''); setPicker('town'); }} />
